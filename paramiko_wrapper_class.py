...
class ClientConnect(object):
    ...
    def file_get(self, remote_file, local_file):
        ...
        self.sftp.get(remote_file, local_file,
                      callback=ClientConnect.sftp_progress)
...
def main():
    ...
    connection_string = ['127.0.0.1', 'scott', 'W377-H337ed']
    ...
    connection.file_put('output.txt',
                        '/home/scott/output.txt')

    connection.file_change_permissions('/home/scott/output.txt', 777)
